...
function startCountdown(){
    action = setInterval(function(){
        ...
        {//game over
            ...
            `<form action=\"/mathgame3score\" method=\"POST\">
            <input type=\"text" id=\"emailUser" name=\"emailUser\" value=""><br>
            <input type=\"text" id=\"fname" name=\"quickMathScore\" value="scor"><br>
            
            <input type=\"submit\" value=\"Submit\">
          </form>
          <p>GAME OVER! </p>` +`<p>YOUR SCORE: ` + score+ "</p>"; 
          document.getElementById("fname").value = parseInt(currentScore) > score ? currentScore : score;
...
function generateQA(){
  ...
  switch (sign) {
    ...
    document.getElementById("problem").innerHTML=randomNumber1+ sign  +randomNumber2;
